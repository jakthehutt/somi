...
- [x] **Step 3** — Schema test fixtures: `supabase/tests/rls.sql` exercising RLS as different roles
...
- [x] **Step 13** — Polish + deploy: `.env.example`, README setup section, Vercel + Supabase prod docs
